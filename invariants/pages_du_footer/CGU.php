...
<head>
	<meta charset="utf-8" />
	<link rel="stylesheet" type="text/css" href="../css/css_footer/style_CGU.css">
	<title>CGU</title>
</head>
...
<<?php include ("header.php") ?>
		<fieldset>
			...
			<textarea rows="15" cols="150" readonly="">
				...
				Le présent document a pour objet de définir les modalités et conditions dans lesquelles d’une part,  Cultivasso, ci-après dénommé l’EDITEUR, met à la disposition de ses utilisateurs le site, et les services disponibles sur le site et d’autre part, la manière par laquelle l’utilisateur accède au site et utilise ses services. 
				Toute connexion au site est subordonnée au respect des présentes conditions. 
				Pour l’utilisateur, le simple accès au site de l’EDITEUR à l’adresse URL suivante www.i_need_eat.fr/ implique l’acceptation de l’ensemble des conditions décrites ci-après. 
				Propriété intellectuelle
				Variante 1 
				La structure générale du site I Need Eat, ainsi que les textes, graphiques, images, sons et  vidéos la composant, sont la propriété de l'éditeur ou de ses partenaires. Toute représentation et/ou reproduction et/ou exploitation partielle ou totale des contenus et services proposés par le site I Need Eat, par quelque procédé que ce soit, sans l'autorisation préalable et par écrit de  I need Eat  et/ou de ses partenaires est strictement interdite et serait susceptible de constituer une contrefaçon au sens des articles L 335-2 et suivants du Code de la propriété intellectuelle.
				...
				L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo I Need Eat institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls. 
